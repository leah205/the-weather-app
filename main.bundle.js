...
function updateCurrentWeather(newUnit, data) {
  var tempValue = currentContainer.querySelector('.current-weather-container > div:nth-child(1) .content');
  tempValue.textContent = "\xB0".concat(data["temp_".concat(newUnit)]);
  var feelsLikeValue = currentContainer.querySelector('.current-weather-container > div:nth-child(3) .content');
  console.log("\xB0".concat(data["feelslike_".concat(newUnit)]));
  // console.log(feelsLikeValue);
  feelsLikeValue.textContent = "\xB0".concat(data["feelslike_".concat(newUnit)]);
  var windChillValue = currentContainer.querySelector('.current-weather-container > div:nth-child(8) .content');
